...
private:
  ...
  {
    publish_status("FSM: NO GOAL CLEARANCES - PLEASE LOAD NEW MAP");
    RCLCPP_WARN(get_logger(), "PLEASE LOAD A NEW MAP. TAKE UGV TO AN ENTIRELY NEW SPOT.");
  }
  ...
  bool prompted_refill_{false};
  bool sunlight_ok_{true};     // live sunlight status
  int soil_raw_{999};         // latest raw soil reading
